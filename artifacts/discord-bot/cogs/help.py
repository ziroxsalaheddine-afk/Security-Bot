...
CATEGORIES: dict[str, dict] = {
    ...
    "Recovery": {
        ...
        "commands": [
            ...
            ("+backup create",                "Snapshots the entire server (roles, categories, channels, emojis, members) and saves it with a unique Backup ID."),
            ("+backup list",                  "Displays an embed listing all saved backups — shows Backup ID, original server name, and creation date."),
            ("+backup load <id>",             "Interactive restore prompt — choose to load Everything, Roles Only, Channels Only, or Emojis Only. Wipes existing content before loading."),
